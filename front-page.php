	...
	<div class="container-fluid wrap">
		...
		<div class="row middle-xs center-xs">
			<div class="col-sm-6 col-xs-12">
				<h1 class="lead m0">Hi, I'm Justin Chick. I'm a designer, developer, traveler, and comic book reader.</h1>
		...
		<div class="row center-xs">
			<?php if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); ?>
				<div class="col-sm-4 col-xs-10 flex pl2 pr2">
					<a href="<?php the_permalink(); ?>" class="ipad mb2-xs">
		...
		<div class="row center-xs mt4">
			<div class="col-sm-10 col-xs-12">
				...
				<p>It's people of all walks of life who use the web every day and I keep this at the forefront of every decision I make. How will this feature/design/experience effect the people who'll be using this site? Who are those people and what do we know about them?</p>
				<p>My work is driven by collaboration, an inquisitive nature, and some good ole fashioned elbow grease. With these three pillars (and over 5 years full-time freelance experience), I'm able to create thoughtful, holistic design solutions that get out of the way to allow people to accomplish what they need to.</p>
				<p>I’m also a devout cyclist, <a href="<?= esc_url(home_url('category/photography')); ?>" title="Photography of Justin Chick | @jchck_">amateur photographer</a>, social justice advocate, vegetarian, and avid DC Comics fan (<a href="<?= esc_url(home_url('dc-27')); ?>">Detective Comics 27, anyone?</a>). Right now you can find me rolling around the western half of North America by train, reading under a tree or enjoying the day in a new cafe.</p>
