	...
	<div class="container-fluid wrap">
		...
		<div class="row middle-xs center-xs">
			<div class="col-sm-6 col-xs-12">
				<h1 class="lead m0">Hi, I'm Justin Chick. I'm a designer, developer, and digital nomad.</h1>
		...
		<div class="row center-xs mt4">
			<div class="col-sm-10 col-xs-12">
				...
				<p>I’m also a devout cyclist, <a href="<?= esc_url(home_url('category/photography/')); ?>" title="Photography of Justin Chick | @jchck_">amateur photographer</a>, social justice advocate, vegetarian, and avid DC Comics fan (Detective Comics 27, anyone?). Right now you can <a href="<?= esc_url(home_url('follow-along')); ?>" target="_blank">find me traveling around the globe</a>, reading under a tree or enjoying the day in a new cafe.</p>
