	...
	<div class="row center-xs mt4">
		<div class="col-sm-10 col-xs-12">
			<div class="bg-off-white border-radius p1 p4-xs">
				...
				<p class="m0">Want to find out what we can do together? <br /> <a title="Hire Justin Chick freelance web designer" class="highlight" href="<?= esc_url(home_url('hire-justin')); ?>">This is a good first step.</a></p>
			</div>
		</div>
	</div>
