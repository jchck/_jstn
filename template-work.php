...
<section class="hero hero-top pt3 pb3 pt4-sm pb4-sm">
	<div class="wrap container-fluid">
		<h1 class="text-center m0">Work Template sed vulputate lorem sed nisi maximus porta</h1>
	</div>
</section>

<section class="wrap-sm container-fluid mt3">
	<h2 class="text-center mt0">Phasellus id enim justo. Nulla quis ligula lobortis</h2>
	...
	<div class="row mt3-sm mb3-sm mt2 mb2">
		...
		<article class="col-xs-12 flex">
			<a href="#" class="color-box color-targeting row m0 middle-xs center-xs p3">
				<div class="col-md-2 col-sm-3 col-xs-4">
					<?php get_template_part( 'templates/launches', 'jframe' ); ?>
				</div>
				<div class="col-md-10 col-sm-9 col-xs-12">
					<h3 class="mt0 ml1-md">Project Title</h3>
					<p class="m0 ml1-md">Project Summary velit eu tortor fermentum accumsan tempor at tellus.</p>
				</div>
			</a>
		</article>
