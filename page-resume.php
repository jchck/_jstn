<?php while ( have_posts() ) : the_post(); ?>
	<header class="col-12 sm-col-6 sm-pr3">
		...
		<p class="h3 mb1">I'm currently looking for full-time work in New England.<br />If you're intrested in working together drop me a line:</p>
		<p class="h3 mt0 mb1 caps"><a href="mailto:hey@justinchick.com">hey@justinchick.com</a></p>
		<p class="m0"><a href="#" target="_blank">Download PDF Resume</a></p>
	</header>
