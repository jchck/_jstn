...
<article class="col-12 sm-col-6 pb4">
	...
	<h3 class="h2 bold mt0">Lead Interactive Designer - Hanley Wood</h3>
	<time class="caps">Sep 2016 - Current</time>
	<p class="measure mt0">I coordinate between the design, editorial, and back-end development teams to oversee the front-end of all <a href="http://www.hanleywood.com">Hanley Wood</a> web properties including <a href="http://www.architectmagazine.com/">Architect</a>, <a href="http://www.builderonline.com/">Builder</a> and <a href="http://www.remodeling.hw.net/">Remodeling</a> Magazines.</p>

	<h3 class="h2 bold">Freelance</h3>
	<time class="caps">March 2010 - Current</time>
	<p class="measure mt0">I oversee projects with organizations like <a href="<?= esc_url(home_url('/case-studies/wash-u-med-school')); ?>">Washington University Med School</a> and <a href="<?= esc_url(home_url('/case-studies/dashtaki-law-firm')); ?>">The Dashtaki Law Firm</a> (and many amazing folks in between) to craft custom WordPress solutions so they can achieve their goals.</p>
