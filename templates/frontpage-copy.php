...
<p>I’m also a devout cyclist, <a class="link" href="<?= esc_url(home_url('collection/photography/')); ?>" title="Photography of Justin Chick | @jchck_">amateur photographer</a>, social justice advocate, vegetarian, and avid DC Comics fan (Detective Comics 27, anyone?). Right now you can <a class="link" href="<?= esc_url(home_url('/follow-along')); ?>" tltle="">follow me treking around the globe</a>, reading under a tree, or enjoying the day in a new cafe.</p>

<p class="m0">Want to find out what we can do together? <br /> <a title="Hire Justin Chick freelance web designer" class="link" href="<?= esc_url(home_url('hire-justin')); ?>">This is a good first step.</a></p>